      ...
      <div className='container'>
        <div className='grid md:grid-cols-3 pb-20 pt-5'>
          ...
          <div className='py-8 px-4'>
            ...
            <p className='text-gray-600 dark:text-white/70 lg:pr-24 pt-3'>Lorem ipsum dolor sit,amet consectetur adipisicing elit ,maiores
              alias cum </p>
            <p className='text-gray-500 mt-4'>Made with heart by the coding journey</p>
            <a href="https://www.youtube/channel/UC1H-a1MKEFXRiFlGNLcy7gQ"
              target="_blank" className='inline-block bg-primary/90 text-white py-2 px-4 
              text-sm rounded-full'>Visit our Youtube Channel</a>
          </div>
          {/* Footer Links */}
