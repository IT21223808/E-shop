  ...
  return (
    ...
    <div className='container'>
      <div className='grid grid-cols-5 gap-3 place-items-center opacity-50'>
        <img src={brand1} alt='barnd' className='w-[80px] dark:invert' />
        <img src={brand2} alt='barnd' className='w-[80px] dark:invert' />
        <img src={brand3} alt='barnd' className='w-[80px] dark:invert' />
        <img src={brand4} alt='barnd' className='w-[80px] dark:invert' />
        <img src={brand5} alt='barnd' className='w-[80px] dark:invert' />
        </div>
      </div>
    </div>
  )
