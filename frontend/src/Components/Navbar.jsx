              ...
              <ul className='flex items-center gap-4'>
                ...
                <li className='relative cursor-pointer group'>
                  <a href='#' className='flex items-center gap-[2px] font-semibold
                   text-gray-500 dark:hover:text-white py-2' >Quick Links
                    ...
                    <ul className='space-y-2'>
                      {
                        DropdownLinks.map((data,index)=>(
                          <li className=''>
                            <a className='text-gray-500 dark:hover:text-wh:duration-200 inline-block w-full p-2 hover:bg-primary/20
                            rounded-md font-semibold' href={data.link} >{data.name}</a>
                          </li>
                        ))
                      }
                    </ul>
